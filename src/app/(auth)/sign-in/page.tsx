  ...
  return (
    <CardWithLogo>
      <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg border flex flex-col items-center">
        ...
        {/* Email/Password Form */}
        <form className="space-y-4 w-full" onSubmit={handleEmailSignIn}>
          <div>
          ...
          <Button
            type="submit"
            className="w-full mt-2 font-semibold rounded-lg bg-blue-500 text-white hover:text-white hover:bg-blue-700"
